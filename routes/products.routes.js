...
const { getAllProducts, uploadProduct, getOneProduct, deleteProduct, editProduct, getUserProducts, getProductType, getProductFav, quitProductFav, getFavProduct, applyForProduct, getDonations } = require("../controllers/products.controller")
...
router.post("/applyForProduct/:product_id", isAuthenticated, applyForProduct)
